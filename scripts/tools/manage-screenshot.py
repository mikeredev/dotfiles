...
i3 area screenshot:     bindsym --release $mod+Shift+Print exec --no-startup-id sh -c 'python ~/data/scripts/system-tools/manage-screenshot.py --type area'
"""
...
def take_screenshot(screenshot_type="full"):
    ...
    subprocess.run(["dunstify", "Screenshot taken", file_path, "-a", "manage-screenshot", "-u", "low"])
